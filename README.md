...
- 📦🆓 [OSINT Toolbox MCP](https://github.com/renkagod/osint-toolbox-mcp) — Runs nine OSINT tools on your machine: Sherlock, Maigret and Blackbird (usernames), Holehe and GHunt (email), theHarvester and SpiderFoot (domains), PhoneInfoga (phone numbers) and ExifTool (file metadata). No API keys; uvx package or Docker image.
