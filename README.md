...
- 📦🆓 [Statsnet](https://github.com/usenetstate/statsnet-mcp) — World company background check via remote MCP: registration, executives, courts and finances. Free public cards; deeper data via API subscription. MCP: https://statsnet.co/mcp
